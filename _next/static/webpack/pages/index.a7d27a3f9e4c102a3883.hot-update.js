...
var ButtonFront = styled_components__WEBPACK_IMPORTED_MODULE_0__.default.button.withConfig({
  ...
  var alt = _ref12.alt;
  return alt ? 'linear-gradient(270deg, rgba(160,119,255,1) 0%, rgba(28,0,91,1) 35%, rgba(121,0,119,1) 100%)' : 'linear-gradient(90deg, rgba(160,119,255,1) 0%, rgba(28,0,91,1) 35%, rgba(121,0,119,1) 100%)';
}, function (_ref13) {
